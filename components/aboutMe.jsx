...
export default function AboutMe() {
  const woAmI =
    "I am a 16 year old web and video game programmer who is constantly looking to learn new things. It all started when I joined a Pokemon hackroms community, where I realized that programming was my thing. Now I have experience making videogames and web pages with different modalities and technologies.";
  const myHobbys =
